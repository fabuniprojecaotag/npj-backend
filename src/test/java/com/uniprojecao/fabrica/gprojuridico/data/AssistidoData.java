...
public class AssistidoData {
    public static List<Assistido> seedWithAssistido() {
        ...
        return List.of(
                new AssistidoCivil("Cleyton Pina Auzier", "14.762.687-0", "288.610.170-29", "Brasileiro", "Superior", "Casado", "Advogado", "(61) 92413-0161", "cleyton.pina@example.com", new Assistido.Filiacao("Thayanna Moraes Elias", "José Mário Sena Santos"), "R$ 9.000", endereco, "Brasília", "21/02/1985", 3),
                new AssistidoCivil("Carmen Azevedo Dores", "30.578.754-8", "037.886.591-90", "Brasileira", "Superior", "Casada", "Professora", "(61) 92152-4592", "carmen.azevedo@example.com", new Assistido.Filiacao("Rosiméri Aguiar Rubi Teixeira", "Bento Leonicio da Mota Ervano"), "R$ 5.200", endereco, "Brasília", "14/04/1993", 1),
