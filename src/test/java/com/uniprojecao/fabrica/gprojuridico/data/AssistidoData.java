...
public class AssistidoData {
    public static List<Assistido> seedWithAssistido() {
        ...
        return List.of(
                ...
                new AssistidoTrabalhista("Rogério Bezerra Brito", "48.433.953-9", "223.128.851-66", "Brasileiro", "Mestrado", "Solteiro", "Gerente financeiro", "(61) 93872-0425", "rogerio.bezerra@example.com", new Filiacao("Kamila Ervano Quintanilha", "Osvaldo dos Anjos Cordeiro"), "R$ 11.100", endereco, new AssistidoTrabalhista.Ctps("0921002", "001-0", "DF"), "276.65825.76-7", true)
        );
    }
